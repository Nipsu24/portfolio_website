...
In the past two years, I have completed extensive training in C and C++ programming and recently expanded my focus to full-stack web development, building experience in both frontend interfaces and backend API design.
